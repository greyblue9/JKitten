...
def read_args():
  ...
  g11.add_argument(
    "--standard", "-s", action="store_true", help="Load the Standard AIML Set"
  )
  g11.add_argument(
    "--alice", "-a", action="store_true", help="Load the Alice AIML Set"
  )
  g11.add_argument("--aiml", nargs="+", help="Load AIML file(s)")
  g11.add_argument("--brain", metavar="BRAINFILE", help="Load a dumped brain file")
  ...
  g3.add_argument(
    "--save", metavar="FILENAME", help="Dump the loaded brain to a file"
  )
  g3.add_argument(
...
def main():
  ...
  if args.standard:
    ...
    kern.bootstrap(learnFiles="startup.xml", commands="load aiml b", chdir=chdir)
  elif args.alice:
    chdir = os.path.join(aiml.__path__[0], "botdata", "alice")
    kern.bootstrap(learnFiles="startup.xml", commands="load alice", chdir=chdir)
  elif args.aiml:
    kern.bootstrap(learnFiles=args.aiml, commands=args.commands, chdir=args.chdir)
  elif args.brain:
