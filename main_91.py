...
async def alice_response(bot_message, uid):
  ...
  log.debug("alice_response(%r, %r): feeding %r", bot_message, uid, last_input)
  await loop.run_in_executor(
    None, chat.multisentenceRespond, last_input
  )
  log.debug("alice_response(%r, %r): feeding %r", bot_message, uid, last_response)
  await loop.run_in_executor(
    None, chat.multisentenceRespond, last_response
  )
