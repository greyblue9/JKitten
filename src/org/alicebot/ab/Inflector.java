 ...
 * the <a href="http://api.rubyonrails.org/classes/Inflector.html">Inflectorclass in <a
 * href="http://www.rubyonrails.org">Ruby on Rails, which is distributed under the <a
 * href="http://wiki.rubyonrails.org/rails/pages/License">Rails license.
 *
...
public class Inflector {
  ...
  public String upperCamelCase(String lowerCaseAndUnderscoredWord, char... delimiterChars) {
    ...
    /**
     * By default, this method converts strings to UpperCamelCase. If the uppercaseFirstLetterargument to false,
  ...
  public String camelCase(String lowerCaseAndUnderscoredWord, boolean uppercaseFirstLetter, char... delimiterChars) {
    ...
    /**
     * Makes an underscored form from the expression in the string (the reverse of the `#camelCase(String, boolean, char[])
  ...
  public String capitalize(String words) {
     ...
     * Like `#titleCase(String, String[])', this is meant for creating pretty output.
     *
     * Examples:
     *
     * 
  ...
  public String ordinalize(int number) {
    ...
    // ------------------------------------------------------------------------------------------------
    /**
     * Determine whether the supplied word is considered uncountable by the `#pluralize(Object) pluralize' and
     * `#singularize(Object) singularize' methods.
     *
     * @param word the word
  ...
  public void addUncountable(String... words) {
     ...
     *
     * The Java `Pattern regular expression processing' does not use the preprocessing directives \l,
     * &#92;u, \L, and \U. If so, such directives could be used in the replacement string
     * to uppercase or lowercase the backreferences. For example, \L1would lowercase the first backreference, and
     * &#92;u3would uppercase the 3rd backreference.
     *
     *
     * @param input
     * @param regex
