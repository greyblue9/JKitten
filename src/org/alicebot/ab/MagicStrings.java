...
public class MagicStrings {
    ...
    public static String default_bot_response = "wut?";
    public static String error_bot_response = "oh shit..";
    ...
    public static String default_that = "you";
    public static String default_topic = "you";
    public static String default_list_item = "NIL";
    public static String undefined_triple = "NIL";
    public static String unbound_variable = "idk";
