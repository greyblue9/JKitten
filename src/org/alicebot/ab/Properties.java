...
public class Properties extends HashMap<String, String> {
  ...
  @return roperty value or a string indicating the property is undefined
  */
  public String get(String key) {
  String result = super.get(key);
  if (result == null) return MagicStrings.default_property; else return result;
  }
  ...
  */
   ...
   *
  @param filename ile containing bot properties
  */
